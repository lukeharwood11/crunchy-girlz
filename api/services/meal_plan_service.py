...
class MealPlanService:
    ...
    async def update_meal_type(
        self, type_id: int, type_data: MealTypeUpdate
    ) -> Optional[MealType]:
        """Update a meal type"""
        try:
            data = type_data.model_dump(exclude_none=True)
    ...
    async def create_meal_plan(
        self, plan_data: MealPlanCreate, user_id: str
    ) -> MealPlan:
    ...
    async def update_meal_plan(
        self, plan_id: int, plan_data: MealPlanUpdate, user_id: str
    ) -> Optional[MealPlan]:
    ...
    async def add_recipe_to_meal_plan(
        self, recipe_data: MealPlanRecipeCreate
    ) -> MealPlanRecipe:
        ...
        try:
            ...
            response = (
                self.supabase.table(self.recipe_table_name).insert(data).execute()
            )
    ...
    async def get_meal_plan_recipes(self, plan_id: int) -> List[MealPlanRecipe]:
        ...
        try:
            response = (
                self.supabase.table(self.recipe_table_name)
                .select("*")
    ...
    async def update_meal_plan_recipe(
        self, recipe_id: int, recipe_data: MealPlanRecipeUpdate
